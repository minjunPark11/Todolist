...
export const en: Dictionary = {
  ...
  "settings.nav.connections": "Connections & sharing",
  ...
  "settings.google.timezoneLabel": "Sync time zone",
  "settings.google.timezoneLabelHint": "The zone Google events are read and written in. Changing it also sets this account's own time zone — they have to agree.",
  "settings.google.timezoneConfirmTitle": "Change the sync time zone?",
  "settings.google.timezoneConfirmBody": "Google sync will be pinned to {{timezone}}, and this account will plan in it. The next sync re-reads the whole calendar and corrects the times of everything imported from it.",
  "settings.google.timezoneConfirm": "Change it",
