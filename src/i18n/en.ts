...
export const en: Dictionary = {
  "googleTask.deletedConflict": "Deleted in Google, edited in the app",
  "googleTask.keepTask": "Keep app task",
  "googleTask.acceptDelete": "Accept deletion",

  "settings.accessPermissions": "Access permissions",
  "calendar.share": "Share",
  "calendar.manage": "Calendars",
  "settings.google.automatic": "Changes sync automatically.",
  "settings.google.exceptions": "Needs attention ({{count}})",
  "settings.google.history": "Recent changes",
  "settings.google.historyNote": "Versions before changes, kept for 30 days. Restored content syncs again.",
  "settings.google.restoreVersion": "Restore this content",
  "settings.google.historyEmpty": "No saved versions yet.",
  "settings.google.historyFailed": "Could not load or restore versions. Please retry.",

  "settings.nav.general": "General",
  "settings.nav.notifications": "Notifications",
  "settings.nav.account": "Account & sync",
  "settings.nav.connections": "Connections",
  "settings.nav.data": "Backup & restore",
  "settings.nav.about": "About",
  "settings.categories": "Settings categories",
  "settings.connectionSettings": "Connection settings",
  "settings.syncScope": "Sync scope and limitations",
  "settings.shareManagement": "Manage sharing link",
  "settings.focusDisplay": "Timer display",
  "settings.calendarDisplay": "Calendar display",
  "settings.dangerZone": "Reset data",
  "settings.notificationTroubleshooting": "Troubleshoot notifications",
  "settings.subscriptionUrl": "Calendar subscription URL",
  "settings.deviceReview": "Device change review",
  "settings.deviceReviewNeeded": "{{count}} tasks need your decision. Other tasks continue syncing.",
  "settings.deviceReviewClear": "No device conflicts need review.",
  "settings.reviewDevices": "Review {{count}} device conflicts",
  "settings.syncDetails": "Latest sync details",
  "settings.groupAppearance": "Appearance",
  "settings.groupRegion": "Language & time",
  "settings.groupBehavior": "App behavior",
  "googleTask.localSkipped": "Tasks awaiting calendar sync: {{count}}",
  "googleTask.localUnsupported": "Check the date, complete start/end times and repeat settings. Unverified old event IDs need mapping review.",
  "googleTask.transferTitle": "Tasks from another connection ({{count}})",
  "googleTask.transferNote": "Copy selected tasks into calendar {{calendar}}. Each gets a new event; the original calendar stays as it is.",
  "googleTask.repeat.daily": "Every {{count}} day(s)",
  "googleTask.repeat.weekly": "Every {{count}} week(s)",
  "googleTask.repeat.monthly": "Every {{count}} month(s)",
  "googleTask.repeat.yearly": "Every {{count}} year(s)",
  "googleTask.until": "Until {{date}}",
  "googleTask.extraRepeat": "Includes additional dates or exceptions",
  "googleTask.customRepeat": "Custom Google repeat rule",
  "googleTask.ruleDetails": "Rule details",
  "googleTask.transfer": "Copy to this calendar",
  "googleTask.repeatTitle": "Different repeat rules",
  "googleTask.repeatNote": "Edit repeat settings in the app, then apply them here. Applying replaces Google's rule and exception-date list for the entire series. Shared-content sync keeps the current Google rule.",
  "googleTask.applyRepeat": "Apply app repeat rule",
  "googleTask.noRepeat": "Does not repeat",
  "googleTask.copy": "Keep local content as a new task",
  "googleTask.deviceConflict": "Changes from another device",
  "googleTask.mergeSummary": "Latest sync: {{count}} tasks automatically merged · {{remaining}} device conflicts remaining",
  "googleTask.wholeTask": "This choice applies to the whole task, including its list, status and other details.",
  "googleTask.saved": "Saved on account",
  "googleTask.deleted": "Deleted",
  "googleTask.useSaved": "Use saved version",
  "googleTask.title": "Google sync review",
  ...
  "googleTask.recheck": "Check result",
  "googleTask.cancel": "Cancel unsent write",
  "googleTask.clear": "No items need review.",
  "googleTask.untitled": "Untitled event",
  "googleTask.conflict": "Conflicting edits",
  "googleTask.excluded": "Not imported",
  "googleTask.restored": "Restored in Google",
  "googleTask.duplicate": "Possible duplicate",
  "googleTask.local": "App content",
  "googleTask.remote": "Google content",
  "googleTask.unsupported": "Recurring or unsupported schedules are kept in Google without being imported or shortened.",
  "googleTask.useApp": "Use app content",
  "googleTask.useGoogle": "Use Google content",
  "googleTask.restore": "Restore task",
  "googleTask.import": "Import as a separate task",
  "googleTask.keepTrash": "Keep task in trash",
  "googleTask.exclude": "Do not import this event",
  "googleTask.later": "You can close this item and decide later. It will stay in review.",
  "googleTask.more": "Show more",
  "googleTask.skipped": "Not imported: {{count}}",
  // ---- common ----
  ...
  "common.clear": "Clear",
  "recurrence.scope.editTitle": "Edit repeating task",
  "recurrence.scope.deleteTitle": "Delete repeating task",
  "recurrence.scope.this": "This occurrence",
  "recurrence.scope.following": "This and following",
  "recurrence.scope.all": "All occurrences",
  ...
  "timeline.rowMenu": "Task menu",
  "timeline.openTask": "Open task",
  "timeline.clearDates": "Clear dates",
  "timeline.showDone": "Show completed",
  "timeline.navigate": "Move the window",
  "timeline.display": "View",
  "timeline.showMilestones": "Show milestones",
  "timeline.focusRunning": "Focusing now",
  "timeline.focusOutside": "Focusing now, outside the planned dates",
  "timeline.focused": "focused",
  "timeline.sessionCount": "{count} sessions",
  ...
  "tasks.emptyTrashLists": "{{lists}} lists go too, and the {{tasks}} tasks inside them.",
  ...
  "rail.sync": "Sync now",
  "rail.syncing": "Syncing…",
  "rail.syncFailed": "Sync failed — try again",
  "rail.notifications": "Notifications",
  "rail.notificationsUnread": "Notifications ({{count}} unread)",
  "notifications.tabNotifications": "Notifications",
  "notifications.tabActivities": "Activities",
  "notifications.empty": "No notifications",
  "notifications.emptyBody": "Notifications you missed collect here.",
  "notifications.activitiesEmpty": "Nothing yet",
  "notifications.activitiesEmptyBody": "Finishing work and focus sessions show up here.",
  "notifications.syncFailedTitle": "Sync failed",
  "notifications.syncFailedBody": "Your changes are saved on this device. {{reason}}",
  "notifications.calendarFailedTitle": "Calendar sync failed",
  "notifications.calendarFailedBody": "{{name}} could not be refreshed. {{reason}}",
  "notifications.updateTitle": "Update available",
  "notifications.updateBody": "Version {{version}} is ready to install.",
  ...
  "settings.subtitle": "Preferences, connections and your data.",
  ...
  "settings.timezoneHint": "Used by the app and Google sync. Imported events are recalculated to preserve their actual time.",
  "settings.timezoneAuto": "Use this device’s time zone",
  "settings.timezoneAutoNamed": "Use this device’s time zone — {zone}",
  ...
  "settings.focus.completionNotificationHint": "Requires notification permission below.",
  "settings.focus.miniTimerButtonHint": "Opens the running timer in its own small window — a popup, in a browser.",
  ...
  "settings.confirmBeforeDeleteHint": "Ask before a delete that cannot be undone. A delete that goes to the trash does not ask.",
  ...
  "settings.importGateTitle": "Replace everything with this file?",
  "settings.importGateBody": "Importing replaces everything on this device. In the file — tasks {{fileTasks}}, lists {{fileLists}}. Here now — tasks {{currentTasks}}, lists {{currentLists}}.",
  "settings.importGateEmpty": "The file holds nothing. If it is not an export from this app, importing it empties this device.",
  "settings.importGateConfirm": "Replace",
  "settings.importDone": "Import complete.",
  "settings.importInvalidFile": "Import failed: that file is not an export from this app.",
  "settings.importInvalidJson": "Import failed: that file is not JSON.",
  "settings.importUnreadable": "That file could not be read. Try choosing it again.",
  ...
  "settings.updateIdle": "Not checked yet.",
  "settings.updateWebOnly": "The web app is always its latest version. Only the installed app downloads updates.",
  ...
  "settings.calendar.loginRequired": "Sign in to your FocusFlow account to share your calendar.",
  ...
  "settings.google.error.reviewsUnresolved": "Resolve the pending items in the Google task review panel below, then try again.",
  "settings.google.error.bindingChanged": "The Google connection changed during this request. Reload settings and try again.",
  ...
  "settings.google.status.connecting": "Waiting for Google authorization…",
  "settings.google.status.connected": "Connected",
  "settings.google.status.error": "Could not check connection",
  "settings.google.retry": "Check again",
  "settings.google.sources.title": "Calendars to sync",
  "settings.google.sources.hint": "Events in the calendars you tick appear in FocusFlow, and edits here go back to Google.",
  "settings.google.sources.loading": "Reading your calendars…",
  "settings.google.sources.empty": "This account has no calendars to sync.",
  "settings.google.sources.readOnly": "read-only",
  "settings.google.cancelConnect": "Cancel connection",
  ...
  "settings.google.signedOut": "Sign in to your FocusFlow account to connect.",
  "settings.google.connecting": "Connecting...",
  "settings.google.disconnect": "Disconnect",
  "settings.google.connected": "Connected. A FocusFlow calendar is ready in your Google account.",
  "settings.google.connectedAs": "Connected as {{email}}.",
  "settings.google.connectedNoEmail": "Connected.",
  "settings.google.cancelled": "Not connected — you cancelled on Google's screen.",
  "settings.google.disconnected": "Disconnected. Events already in your Google calendar were left alone.",
  "settings.google.disconnectedNotRevoked": "Disconnected here, but Google may still list FocusFlow. Remove it in your Google account to be sure.",
  "settings.google.disconnectTitle": "Disconnect Google Calendar?",
  ...
  "settings.google.error.updateRequired": "Update FocusFlow to continue syncing Google Calendar.",
  "settings.google.error.identityMismatch": "The existing Google account could not be matched. Disconnect the existing connection before connecting another account.",
  "settings.google.error.identityUnavailable": "Could not verify the Google account. The existing connection was kept. Try again later.",
  "settings.google.error.lifecycleBusy": "Another Google connection operation is running. Try again shortly.",
  "settings.google.error.lifecycleRecovery": "The result of a Google connection operation is uncertain. Connecting and disconnecting are paused until the service operator verifies recovery.",
  "settings.google.error.calendarVerification": "Could not verify the dedicated calendar's ownership or time zone, or the connection changed. The existing connection was kept. Check the calendar and try again.",
  "settings.google.error.policyUnavailable": "Google sync is paused because compatibility could not be verified. Try again shortly.",
  "settings.category.title": "Category management",
  "settings.category.hint": "The colours the calendar paints with, for the things it does not own.",
  "settings.category.listsNote": "Your own calendars are your Lists — rename, recolour and delete them where your Lists live.",
  "settings.category.colorLabel": "Colour",
  ...
  "schedule.clearTimeField": "Clear {{label}}",
  "schedule.back": "Back",
  "schedule.rangeStart": "Start",
  "schedule.rangeEnd": "End",
  "schedule.allDay": "All day",
  "schedule.noDate": "Pick a date",
  ...
  "schedule.reminder.1d-9am": "1 day before",
  "schedule.reminder.on-day": "On the day",
  "schedule.reminder.2d": "2 days before",
  "schedule.reminder.1w": "1 week before",
  ...
  "schedule.reminder.withTime": "{{label}} ({{time}})",
  "schedule.reminder.customRelative": "Custom…",
  "schedule.reminder.count": "How many",
  "schedule.reminder.unit": "Unit",
  "schedule.reminder.remindAt": "Remind me at",
  "schedule.reminder.previewAt": "{{label}}. Remind me at {{time}} on {{date}}.",
  "schedule.reminder.previewNoDate": "Pick a date first — there is nothing to count back from yet.",
  "schedule.reminder.previewInvalid": "Enter a whole number of 1 or more.",
  "schedule.reminder.before.minute.one": "1 minute early",
  "schedule.reminder.before.minute.other": "{{n}} minutes early",
  "schedule.reminder.before.hour.one": "1 hour early",
  "schedule.reminder.before.hour.other": "{{n}} hours early",
  "schedule.reminder.before.day.one": "1 day early",
  "schedule.reminder.before.day.other": "{{n}} days early",
  "schedule.reminder.before.week.one": "1 week early",
  "schedule.reminder.before.week.other": "{{n}} weeks early",
  "schedule.unit.minute": "Minute",
  "schedule.unit.hour": "Hour",
  "schedule.unit.day": "Day",
  "schedule.unit.week": "Week",
  ...
  "matrix.pageMenuAria": "View settings",
  "matrix.pageMenuAriaFiltered": "View settings — filters on",
  ...
  "tasks.trashListArchived": "Archived",
  "tasks.trashListsTitle": "Lists",
  "tasks.listDeleteForeverTitle": "Delete \"{{list}}\" forever?",
  "tasks.trashListTaskCount": "{{count}} tasks",
  "tasks.listDeleteForeverBody": "This also deletes {{count}} tasks, for good.",
  "tasks.scopeMenu": "View and options",
  "tasks.kanbanSize": "Kanban Size",
  ...
  "tasks.hideDetails": "Hide details",
  "tasks.showCountdown": "Show countdown",
  ...
  "tasks.addPlaceholderIn": "Add a task to {{list}}",
  ...
  // one.
  "tasks.refuse.noList": "These tasks have no list left to sit in. A drop cannot put one here.",
  ...
  // The row draws no flag any more, so this is where a screen reader hears the
  // level (TASK_ROW_TWO_LINES_DESIGN.md §2.2).
  ...
  // Pin left the menu (TASK_MENU_TRIM_DESIGN.md), but `pinnedAt` is still on
  // the records that had it and `taskActivity` still reads it — a history is
  // what happened, and this is the word for one of the things that did.
