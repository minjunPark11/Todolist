...
const UNREAD: Record<string, string> = {
  // §19.5 의 여덟 단. 다섯이 아직 안 불리지만 척도는 완결돼야 쓸모가 있다 —
  // `layers.test.ts` 가 남은 리터럴 28곳을 이 단들로 옮기는 길을 열어뒀고,
  // 그 길의 도착점이 바로 이 이름들이다.
  "--z-base": "겹침 척도의 완결성",
  "--z-tooltip": "겹침 척도의 완결성",
  "--z-popover": "겹침 척도의 완결성",
  "--z-menu": "겹침 척도의 완결성",
  "--z-overlay": "겹침 척도의 완결성",
