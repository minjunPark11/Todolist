...
const PRESET_KEY: Record<string, string> = {
  ...
  "Space for papers and experiments": "spaceHub.preset.subtitleResearch",
  ...
  "+ Research Task": "spaceHub.preset.addResearchTask",
  "+ Note": "spaceHub.preset.addNote",
  "+ Study Note": "spaceHub.preset.addStudyNote",
  "+ Paper Note": "spaceHub.preset.addPaperNote",
  ...
  "Next Research Step": "spaceHub.preset.nextResearchStep",
  "Current Signal": "spaceHub.preset.currentSignal",
  "Study Signal": "spaceHub.preset.studySignal",
  "Research Signal": "spaceHub.preset.researchSignal",
  ...
  "Research Time": "spaceHub.preset.researchTime",
  ...
  "Upcoming Research": "spaceHub.preset.upcomingResearch",
  "AI Space Summary": "spaceHub.preset.aiSpaceSummary",
  "AI Study Summary": "spaceHub.preset.aiStudySummary",
  "AI Research Summary": "spaceHub.preset.aiResearchSummary",
