...
- `C:\Users\minju\Todolist\.env.example`: Supabase/Ollama 설정 예시
...
- `C:\Users\minju\Todolist\src\components\ai`: AI action preview UI
- `C:\Users\minju\Todolist\src\hooks`: 데이터 저장/동기화 hook
- `C:\Users\minju\Todolist\src\utils`: 날짜, planner 계산, calendar item/time 변환
- `C:\Users\minju\Todolist\src\lib`: AI, Ollama, calendar context
