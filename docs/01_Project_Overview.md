...
FocusFlow는 개인 작업관리, 캘린더, 프로젝트 관리, 공부 노트/복습을 한 화면 구조 안에 묶은 React 기반 생산성 웹앱이다. AI 비서는 2026-08-27에 제거되었다 (`LOCAL_AI_REMOVAL_DESIGN.md`).
...
- 제거됨(2026-08-27): 채팅과 agent action preview/apply 일체
