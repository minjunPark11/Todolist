...
> **정정 (2026-08-14, 조사 후).** 시간 지평 모델에 대한 아래 판단은 조사로
> 뒷받침됐다(지평 5단계, 상하 분해, 목표가 1급, 지평 간 드래그 — 전부 확인).
> 다만 **D9의 "색은 Board(=Space)가 소유"는 Timestripe 이식이 아니다** — 우리
> 발명이고, 근거는 캘린더와의 색 언어 일관성이다. `TIMESTRIPE_REFERENCE.md` §2·§4 참조.
